...
// Represents connections to the colony database.
// Allows to start/create transaction.
type Client struct {
	pools []pool.Pool
}

// Represents an colony server.
...
// Recreates a new colony client connected to the given colony servers.
...
// Starts an interactive transaction and registers it on the colony server.
...
// Creates a static transaction object. Does not communicate with the colony server.
