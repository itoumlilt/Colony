...
import { Connection, Transaction, connect, CrdtSet, CrdtCounter } from "./colony"
...
async function testcolony(): Promise<any> {
...
async function testcolony2(): Promise<any> {
...
async function friendshipExample(): Promise<any> {
	...
	// // TODO reset not yet supported by colony
	// connection.update([
