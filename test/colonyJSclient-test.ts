...
import "mocha";
import { colonyConnection } from "../src/colonyConnection"
import { Connection, Transaction, connect, CrdtSet, CrdtCounter } from "../src/colony"
...
describe("colony client", function () {
	...
	before(() => {
		...
		// use random buckets, so that we can rerun the tests without cleaning and restarting colony
	...
	describe('transactions', () => {
		...
		it('can do batch-reads', async () => {
			...
			vals.sort(); // TODO remove this when order is fixed in colony
